...
<html>
    ...
    <body class="bg-dark w-100 min-vh-100 bg-light d-flex justify-content-center align-items-center flex-column">
        <h1 class="text-center text-white">Coloca tu nuevo producto</h1> 
        <form:form  cssClass="w-25 rounded p-3 fo" enctype="multipart/form-data" action="insert.html" commandName="producto" method="POST">
            <div class="textico"></div>
            <form:label path="nombre" class="text-white">Nombre del Producto:</form:label>
            <form:input cssClass="form-control nom " type="text" path="nombre"></form:input>

            <form:label path="img" class="text-white">URL del Producto:</form:label>
            <form:input cssClass="form-control arch" type="file"  path="img"></form:input>
            ...
            <form:input cssClass="form-control val" type="number"  path="valor"></form:input>
                ...
                <button  class="btn btn-success d-block mx-auto mt-1 w-50 btnEnviar">Enviar</button>
        </form:form>
        ...
        <script>
            ...
            Enviar.addEventListener("click", (e) => {
                if (Nombre.value == "" || Des.value == "" || Archivo.value == "" || Valor.value == "") {
